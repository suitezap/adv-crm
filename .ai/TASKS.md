...
| `SKILLS-UPD-002` | Governança / Tooling | IMPLEMENTED_NOT_VERIFIED | OpenCode | - | Instalar 3 skills UI v17.3.0 (`laravel-expert`, `frontend-dev-guidelines`, `redesign-existing-projects`) em `.agents/skills/`. Instaladas e 19/19 `SKILL.md` verificados em 2026-09-16; pendente smoke test na IDE. Lock `.ai/locks/SKILLS-UPD-002.lock.yaml`. |
