...
| `SEC-HARD-002` | Platform / Segurança | VERIFIED | OpenCode | - | Ondas 1+2 blades: gates `bouncer()` em 28 blades + null-guards JS. Pest 119/119 local 2026-09-12. Achado: `EscavadorController` (index/servico/certificados) sem gates — follow-up Onda 3. |
