        ...
        <x-admin::form id="processo-form" :action="route('admin.processos.update', $processo->id)" method="PUT" enctype="multipart/form-data">
            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="flex gap-4">
                    ...
                    <div
                        class="flex w-1/2 flex-col gap-4 rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
                        ...
                        <x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group.control type="text" name="numero_cnj" :value="old('numero_cnj', $processo->numero_cnj)" :label="trans('lawfirm::app.processos.form.cnj')"
                        ...
                        <x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group.control type="text" name="protocolo_distribuicao"
                                ...
                                label="Protocolo de Distribuição" placeholder="Caso não tenha CNJ ainda" />
                        ...
                        <x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group.control type="text" name="valor_causa"
                                ...
                                :label="trans('lawfirm::app.processos.form.valor')" placeholder="R$ 0,00" />
                ...
                <div class="flex w-1/2 flex-col gap-4 rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
                    ...
                    <x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group.control type="text" name="link_acesso"
                            ...
                            :label="trans('lawfirm::app.processos.form.link')" placeholder="https://" />
                    ...
                    <x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group.control type="text" name="link_audiencia"
                    ...
                    <x-admin::form.control-group class="!mb-0 h-full">
                        <x-admin::form.control-group.control type="textarea" name="descricao"
                            class="!h-full min-h-[100px]" rows="4" :value="old('descricao', $processo->descricao)"
            ...
            <!-- BLOCO 2: INFORMAÇÕES COMPLEMENTARES (DETALHES) -->
            <div class="rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
                ...
                <div class="flex gap-4">
                    ...
                    <x-admin::form.control-group class="w-1/4">
                        ...
                        <x-admin::form.control-group.control type="text" name="tribunal" :value="old('tribunal', $processo->tribunal)" :label="trans('lawfirm::app.processos.form.tribunal')"
                    ...
                    <x-admin::form.control-group class="w-1/4">
                        ...
                        <x-admin::form.control-group.control type="text" name="comarca" :value="old('comarca', $processo->comarca)" :label="trans('lawfirm::app.processos.form.comarca')"
                    ...
                    <x-admin::form.control-group class="w-1/4">
                        ...
                        <x-admin::form.control-group.control type="text" name="vara" :value="old('vara', $processo->vara)" :label="trans('lawfirm::app.processos.form.vara')"
                    ...
                    <x-admin::form.control-group class="w-1/4">
                        ...
                        <x-admin::form.control-group.control type="text" name="juiz_atual" :value="old('juiz_atual', $processo->juiz_atual)" label="Juiz(a) Atual" placeholder="Juiz(a) Atual" />
                ...
                <div class="flex gap-4">
                    ...
                    <x-admin::form.control-group class="w-1/4">
                        ...
                        <x-admin::form.control-group.control type="text" name="subarea_direito"
                    ...
                    <!-- Empty Spacer for now or Link could go here if moved -->
                    <div class="w-1/4"></div>
                </div>
                </div>
                ...
                <div class="flex gap-4">
                    ...
                    <div
                        ...
                        <x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group.control type="select" name="tipo_parte" :label="'Qualificação da Parte'" value="{{ old('tipo_parte', $processo->tipo_parte) }}">
                        ...
                        <x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group.control type="select" name="user_id" :label="'Advogado Responsável'" value="{{ old('user_id', $processo->user_id) }}">
                                <option value="">@lang('lawfirm::app.processos.form.select-choose')</option>
                        ...
                        <div class="flex gap-4">
                            <x-admin::form.control-group class="w-1/2">
                                ...
                                <x-admin::form.control-group.control type="text" name="advogado_responsavel_nome"
                                    :value="old('advogado_responsavel_nome', $processo->advogado_responsavel_nome)"
                                    label="Nome do Advogado" placeholder="Nome do Advogado" />
                            ...
                            <x-admin::form.control-group class="w-1/2">
                                ...
                                <x-admin::form.control-group.control type="text" name="advogado_responsavel_oab"
                                    :value="old('advogado_responsavel_oab', $processo->advogado_responsavel_oab)"
                                    label="OAB" placeholder="123.456/UF" />
                    ...
                    <div
                        ...
                        <x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group.control type="text" name="opposing_party_name"
                                :value="old('opposing_party_name', $processo->opposing_party_name ?? $processo->parte_contraria)" label="Nome / Razão Social" />
                        ...
                        <div class="flex gap-4">
                            ...
                            <x-admin::form.control-group class="w-2/3">
                                ...
                                <x-admin::form.control-group.control type="text" name="opposing_party_document"
                                    id="opposing_party_document" :value="old('opposing_party_document', $processo->opposing_party_document)" label="CPF / CNPJ" oninput="applyMask()" />
                                <x-admin::form.control-group.error control-name="opposing_party_document" />
                            </x-admin::form.control-group>
                        </div>

                        <hr class="border-gray-200 dark:border-gray-800 my-2">
                        <p class="text-sm font-semibold text-gray-600 dark:text-gray-400">Dados do Advogado do Oponente
                        </p>
                        ...
                        <x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group.control type="text" name="advogado_oab"
                        ...
                        <x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group.control type="text" name="whatsapp_advogado_contrario"
                        ...
                        <x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group.control type="email" name="email_advogado_contrario"
