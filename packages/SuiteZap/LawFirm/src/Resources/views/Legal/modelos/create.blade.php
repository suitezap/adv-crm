<x-admin::layouts>
    ...
    <x-admin::form :action="route('admin.modelos.store')">
        <div class="flex flex-col gap-4">
            <!-- Header -->
            <div class="flex items-center justify-between rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
                <div class="flex flex-col gap-2">
                    <div class="text-xl font-bold dark:text-white">📄 Criar Modelo de Documento</div>
                </div>
            ...
            <div class="lf-card flex flex-col gap-5 rounded-xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-gray-900 shadow-sm hover:shadow-md transition-shadow duration-200">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group.control
                            ...
                            rules="required"
                            :value="old('tipo')"
                            placeholder="Ex: Petição Inicial, Procuração, Contrato" />
                ...
                <x-admin::form.control-group>
                    ...
                    <x-admin::form.control-group.control
                        ...
                        name="descricao"
                        :value="old('descricao')"
                        placeholder="Descrição curta para ajudar na escolha do modelo..." />
                ...
                <x-admin::form.control-group>
                    ...
                    <x-admin::form.control-group.control
                        ...
                        rules="required"
                        :value="old('conteudo')"
                        placeholder="Digite o texto base do documento. Use @{{variavel}} para campos dinâmicos..." />
