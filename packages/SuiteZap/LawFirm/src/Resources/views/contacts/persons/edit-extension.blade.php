...
@php
    ...
    $lawDetails = $isEdit
        ? \SuiteZap\LawFirm\Legal\Models\LawPersonDetail::where('person_id', $personId)->first()
        : null;
    ...
    <div class="mt-6 space-y-4 pt-4 border-t border-gray-100 dark:border-gray-800">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <input type="text" name="law_details[cep]" id="law_details_cep"
                    value="{{ old('law_details.cep', $lawDetails->cep ?? '') }}"
                    class="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-blue-500 focus:ring-blue-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300"
                    placeholder="00000-000" maxlength="9" onkeyup="lawFirmHandleCepKeyup(this, 'law_details')"
                    onblur="lawFirmFetchCep(this.value, 'law_details')">
                <span id="law_details_cep_loading" class="text-xs text-blue-500 hidden mt-1"><i
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" name="law_details[logradouro]" id="law_details_logradouro"
            ...
            <div>
                ...
                <input type="text" name="law_details[numero]" id="law_details_numero"
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <input type="text" name="law_details[complemento]" id="law_details_complemento"
            ...
            <div>
                ...
                <input type="text" name="law_details[bairro]" id="law_details_bairro"
            ...
            <div>
                ...
                <input type="text" name="law_details[cidade]" id="law_details_cidade"
            ...
            <div>
                <label class="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">UF</label>
                <select name="law_details[uf]" id="law_details_uf"
                    class="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-blue-500 focus:ring-blue-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 transition-colors duration-200">
                    <option value="">-</option>
                    @foreach($ufs as $uf)
