...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        DB::connection('mothership')->table('app_config')->insertOrIgnore($this->newConfigs);
    }
    ...
    {
        $keys = array_column($this->newConfigs, 'key');
        DB::connection('mothership')->table('app_config')->whereIn('key', $keys)->delete();
    }
};
