    ...
    <template v-else>
        <div class="grid gap-4 rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
            ...
            <div class="flex w-full max-w-full flex-col gap-4 px-8 pt-8" v-if="report?.statistics?.length">
                <x-admin::charts.doughnut ::labels="chartLabels" ::datasets="chartDatasets" />

                <div class="flex flex-wrap justify-center gap-5">
                    <div class="flex items-center gap-2 whitespace-nowrap" v-for="(stat, index) in report.statistics">
                ...
                getStats(filters) {
                    ...
                    this.$axios.get("{{ route('admin.dashboard.stats') }}", {
                        ...
                        .then(response => {
                            ...
                            this.extendColors(this.report?.statistics?.length ?? 0);
