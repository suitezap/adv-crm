...
return [
    ...
    'users' => [
        ...
        'not-permission'   => 'Você não tem permissão para acessar o painel de administração.',
        'login'            => [
            ...
            'index' => [
                ...
                'empty-placeholders' => [
                    ...
                    'calls' => [
                        ...
                        'description' => 'Nenhuma tarefa foi encontrada. Adicione tarefas clicando no botão Atividade e selecionando o tipo Tarefa.',
                    ],
                    'meetings' => [
        ...
        'layouts' => [
            ...
            'header' => [
                'mega-search' => [
                    ...
                    'explore-all-products'          => 'Explorar todos os Serviços',
                    ...
                    'explore-all-matching-products' => 'Explorar todos os Serviços correspondentes a ":query" (:count)',
    ...
    'quotes' => [
        ...
        'create' => [
            ...
            'search-products'   => 'Pesquisar Serviços',
            'link-to-lead'      => 'Vincular a um negócio',
            'quote-item-info'   => 'Adicionar solicitação de Serviço para esta cotação.',
    ...
    'products' => [
        'index' => [
            'title'          => 'Serviços',
            'create-btn'     => 'Adicionar Serviço',
            'create-success' => 'Serviço adicionado com sucesso.',
            'update-success' => 'Serviço atualizado com sucesso.',
            'delete-success' => 'Serviço excluído com sucesso.',
            'delete-failed'  => 'Não foi possível excluir o Serviço.',
            'datagrid'       => [
                'allocated' => 'Alocado',
                'delete'    => 'Excluir',
                'edit'      => 'Editar',
    ...
    'settings' => [
        ...
        'workflows' => [
            ...
            'helpers' => [
                ...
                'update-quote'               => 'Atualizar Cotação',
            ],
            'create' => [
        ...
        'users' => [
            'index' => [
                ...
                'create' => [
                    ...
                    'select-at-lest-one-group' => 'Selecione no mínimo um grupo',
                ],
                'edit' => [
        ...
        'attributes' => [
            ...
            'edit' => [
                ...
                'name'                  => 'Nome',
                'numeric'               => 'Numérico',
                'option-deleted'        => 'A Opção de Atributo foi excluída com sucesso',
                'option-name'           => 'Nome da Opção',
                'option-type'           => 'Tipo de Opção',
                'options'               => 'Opções',
                'phone'                 => 'Telefone',
        ...
        'data-transfer' => [
            'imports' => [
                'create' => [
                    ...
                    'stop-on-errors'      => 'Parar com Erros',
                ...
                'import' => [
                    'back-btn'                => 'Voltar',
                    'completed-batches'       => 'Lotes Totais Concluídos:',
                    ...
                    'indexing-info'           => 'Indexação de Recursos (Preço, Estoque e Elastic Search) em Andamento',
                    ...
                    'validating-info'         => 'Iniciada a leitura e Validação dos Dados',
                ...
                'delete-failed'     => 'Inesperadamente, a exclusão da importação falhou.',
                ...
                'setup-queue-error' => 'Por favor, altere o seu queue driver para "database" ou "redis" para iniciar o processo de importação.',
    ...
    'activities' => [
        ...
        'mass-destroy-success' => 'Atividades excluídas com sucesso.',
        'mass-delete-failed'   => 'As atividades não puderam ser excluídas.',
    ],
    'mail' => [
        'index' => [
            'compose'          => 'Escrever',
    ...
    'leads' => [
        ...
        'create' => [
            ...
            'products'       => 'Serviços',
            'products-info'  => 'Informações sobre os Serviços',
        ],
        'edit' => [
        ...
        'view' => [
            ...
            'products' => [
                ...
                'empty-info'   => 'Nenhum Serviço Encontrado para este Negócio',
                'add-product'  => 'Adicionar Serviço',
            ],
            'persons' => [
    ...
    'configuration' => [
        'index' => [
            ...
            'general'        => [
                ...
                'settings' => [
                    'title'  => 'Configurações',
                    'info'   => 'Atualize as configurações da sua conta aqui.',
                    'footer' => [
                        'info'       => 'Podemos configurar o texto "Powered by" aqui.',
                        'powered-by' => 'Texto do "Powered by"',
                        'title'      => 'Configurações do rodapé (Powered by)',
                    ],
                    'menu' => [
                        'activities'    => 'Atividades',
                        'configuration' => 'Configuração',
                        ...
                        'draft'         => 'Rascunhos',
                        'inbox'         => 'Caixa de Entrada',
                        'info'          => 'Podemos configurar os nomes dos itens do menu lateral aqui.',
                        'leads'         => 'Leads',
                        'mail'          => 'E-mail',
                        'organizations' => 'Empresas',
                        'outbox'        => 'Caixa de Saída',
                    ...
                    'menu-color' => [
                        ...
                        'title'       => 'Configuração de Cores do Menu',
                    ],
                ],
            ],
            'email' => [
    ...
    'dashboard' => [
        'index' => [
            ...
            'top-selling-products' => [
                ...
                'empty-title' => 'Ainda não há dados',
                'empty-info'  => 'Nenhum Serviço disponível para o intervalo selecionado',
            ],
            'top-persons' => [
    ...
    'layouts' => [
        ...
        'warehouses'           => 'Estabelecimento',
        'warehouse'            => 'Depósito',
        'warehouses-info'      => 'Adicionar, editar ou excluir Estabelecimento do CRM',
        'data_transfer'        => 'Transferência de Dados',
        'data_transfer_info'   => 'Gerencie as configurações relacionadas à transferência de dados de pessoas, serviços e oportunidades no CRM',
    ],
    'user' => [
        'account' => [
            'name'                 => 'Nome',
    ...
    'validations' => [
        'message' => [
            'decimal' => 'O campo :attribute precisa ser do tipo decimal.',
        ],
    ],
    'errors' => [
        'dashboard' => 'Dashboard',
        ...
        '404'       => [
            'description' => 'Ops! A página que você está procurando tirou férias. Parece que não conseguimos encontrar o que você estava pesquisando.',
            'title'       => '404 Página Não Encontrada',
        ],
        '401' => [
            'description' => 'Ops! Parece que você não tem permissão para acessar esta página. Verifique se as credenciais necessárias estão corretas.',
            'title'       => '401 Não Autorizado.',
        ],
        '403' => [
            'description' => 'Ops! Esta página é de acesso restrito. Parece que você não tem as permissões adequadas para visualizar este conteúdo.',
            'title'       => '403 Acesso Negado',
        ],
        '500' => [
            'description' => 'Ops! Algo deu errado no servidor. Estamos tendo problemas para carregar a página que você está verificando.',
            'title'       => '500 Erro Interno de Servidor',
        ],
        '503' => [
            'description' => 'Ops! Parece que estamos temporariamente offline para manutenção. Por favor, volte mais tarde.',
